        ...
        <section className='w-full px-4 mt-32 md:mt-64 mb-40 lmd:mb-[396px]'>
            ...
            <div className='max-w-[1300px] mx-auto w-full grid grid-cols-1 md:grid-cols-3 gap-20'>
                <div className='flex flex-col items-center justify-start text-center gap-8'>
                    ...
                    <h4 className='text-deep_gray f-anvenirnext-m text-[28px] font-[600]'>Overcome Creative Blocks</h4>
                    
                    <p className='text-deep_gray f-anvenirnext-m text-lg'>
                ...
                <div className='flex flex-col items-center justify-start text-center gap-8'>
                    ...
                    <h4 className='text-deep_gray f-anvenirnext-m text-[28px] font-[600]'>Boost & Sustain Productivity</h4>
                    <p className='text-deep_gray f-anvenirnext-m text-lg'>Engaging in playful, creative activities can relieve stress and revive energy to keep your productivity going.</p>
                </div>

                <div className='flex flex-col items-center justify-start text-center gap-8'>
                    <img src={Emotions} alt="Feel-good emotions" />
                    <h4 className='text-deep_gray f-anvenirnext-m text-[28px] font-[600]'>Feel-good emotions</h4>
                    <p className='text-deep_gray f-anvenirnext-m text-lg'>The act of creating and connecting with others can promote positive emotions to keep you energized.</p>
                </div>
            </div>
        </section>
    )
